...
{
    public partial class frm11NotaCreditoSuministros : DevExpress.XtraEditors.XtraForm
    {
        List<ENotaCredito> lstNotaCredito = new List<ENotaCredito>();
        bool flag_close = false;
        public string MotivoBaja;
        public frm11NotaCreditoSuministros()
        {
            InitializeComponent();
        }
        ...
        private void cargar()
        {
            ...
            lstNotaCredito = new BVentas().listarNotaCreditoClienteCab(Parametros.intEjercicio).Where(x => x.ncrec_tipo_nota_credito == 3).ToList();
        ...
        private void nuevo()
        {
            ...
            {
                FrmManteNotaCreditoSuministros frm = new FrmManteNotaCreditoSuministros();
                frm.MiEvento += new FrmManteNotaCreditoSuministros.DelegadoMensaje(reload);
        ...
        private void frm11NotaCreditoSuministros_Load(object sender, EventArgs e)
        {
            cargar();
        }
