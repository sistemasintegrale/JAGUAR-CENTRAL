...
{
    public partial class Frm03MovLibroBancosProduccion : DevExpress.XtraEditors.XtraForm
    {
        #region Propiedades

        System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(Frm03MovLibroBancosProduccion));
        ...
        public Frm03MovLibroBancosProduccion()
        {
            InitializeComponent();
        }
        ...
        private void FrmMovLibroBancos_Load(object sender, EventArgs e)
        {
            ...
            BSControls.LoaderLook(lkpBanco, new BTesoreria().listarBancos().Where(x => x.bcoc_icod_banco == 37), "bcoc_vnombre_banco", "bcoc_icod_banco", true);
        ...
        private void imp(ELibroBancos Obe, EVoucherContableCab oBe, List<EVoucherContableDet> lst)
        {
            ...
            reporte.cargar(Obe, oBe, lst.Where(x =>
                Convert.ToInt32(x.ctacc_iid_cuenta_contable_ref) == 0).ToList(), lkpMes.Text, lkpBanco.Text, lkpCuenta.Text, null);
        }
