...
{
    public partial class FrmListarGuiaRemisionMercaderiaVarios : DevExpress.XtraEditors.XtraForm
    {
        #region "Propiedades"

        public List<EGuiaRemisionComprasMercaderia> lstGRM = new List<EGuiaRemisionComprasMercaderia>();
        public List<EGuiaRemisionComprasMercaderia> lstGRSelecionados = new List<EGuiaRemisionComprasMercaderia>();
        public EGuiaRemisionComprasMercaderia _Be { get; set; }
        ...
        public FrmListarGuiaRemisionMercaderiaVarios()
        {
            InitializeComponent();
        }
        ...
        public void Carga()
        {
            lstGRM = new BCompras().listarGuiaRemisionComprasMercaderia().Where(_be => _be.proc_icod_proveedor == proc_icod_proveedor).ToList();
            lstGRM.ForEach(x =>
            {
        ...
        {
            _Be = (EGuiaRemisionComprasMercaderia)viewManoObra.GetRow(viewManoObra.FocusedRowHandle);
            if (flag_multiple)
            {
