...
{
    public partial class FrmListarGuiaRemisionMercaderia : DevExpress.XtraEditors.XtraForm
    {
        #region "Propiedades"

        List<EGuiaRemisionComprasMercaderia> lstpresupuesto = new List<EGuiaRemisionComprasMercaderia>();
        ...
        public FrmListarGuiaRemisionMercaderia()
        {
            InitializeComponent();
        }
        ...
        public void Carga()
        {
            lstpresupuesto = new BCompras().listarGuiaRemisionComprasMercaderia().Where(_be => _be.proc_icod_proveedor == proc_icod_proveedor).ToList();
