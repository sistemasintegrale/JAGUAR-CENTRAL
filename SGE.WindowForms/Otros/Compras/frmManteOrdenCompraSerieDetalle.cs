...
{
    public partial class frmManteOrdenCompraSerieDetalle : DevExpress.XtraEditors.XtraForm
    {
        public List<EProdProducto> oProducto = new List<EProdProducto>();
        public List<EOrdenCompraMercaderiaDetalle> lstDetalle = new List<EOrdenCompraMercaderiaDetalle>();
        public EOrdenCompraMercaderiaDetalle _BE = new EOrdenCompraMercaderiaDetalle();
        public BSMaintenanceStatus oState;
        private BSMaintenanceStatus mStatus;
        public int icod_almacen;
        public int icod_motivo;

        public frmManteOrdenCompraSerieDetalle()
        {
            InitializeComponent();
        }
        ...
        {
            string[] grupo = _BE.ocod_rango_talla.Split('/');
            txtitem.Text = _BE.ocod_iitem.ToString();
            btncodigoProducto.Tag = _BE.prdc_icod_producto;
            btncodigoProducto.Text = _BE.strCodigoProducto;
            txtdescripcion.Text = _BE.strDescProducto;
            txtcantidaddetalle.Text = _BE.ocod_ncantidad.ToString();
            ...
            txttalla1.Text = string.Format("{0:00}", _BE.ocod_talla1);
            txttalla2.Text = string.Format("{0:00}", _BE.ocod_talla2);
            txttalla3.Text = string.Format("{0:00}", _BE.ocod_talla3);
            txttalla4.Text = string.Format("{0:00}", _BE.ocod_talla4);
            txttalla5.Text = string.Format("{0:00}", _BE.ocod_talla5);
            txttalla6.Text = string.Format("{0:00}", _BE.ocod_talla6);
            txttalla7.Text = string.Format("{0:00}", _BE.ocod_talla7);
            txttalla8.Text = string.Format("{0:00}", _BE.ocod_talla8);
            txttalla9.Text = string.Format("{0:00}", _BE.ocod_talla9);
            txttalla10.Text = string.Format("{0:00}", _BE.ocod_talla10);
            txtcantidad1.Text = _BE.ocod_cant_talla1.ToString();
            txtcantidad2.Text = _BE.ocod_cant_talla2.ToString();
            txtcantidad3.Text = _BE.ocod_cant_talla3.ToString();
            txtcantidad4.Text = _BE.ocod_cant_talla4.ToString();
            txtcantidad5.Text = _BE.ocod_cant_talla5.ToString();
            txtcantidad6.Text = _BE.ocod_cant_talla6.ToString();
            txtcantidad7.Text = _BE.ocod_cant_talla7.ToString();
            txtcantidad8.Text = _BE.ocod_cant_talla8.ToString();
            txtcantidad9.Text = _BE.ocod_cant_talla9.ToString();
            txtcantidad10.Text = _BE.ocod_cant_talla10.ToString();
        }
        ...
        private void AgregarDetalle()
        {
            ...
            try
            {
                ...
                _BE.ocod_iitem = Convert.ToInt32(txtitem.Text);
                //_BE.tablc_iid_motivo = Convert.ToInt32(icod_motivo);
                _BE.prdc_icod_producto = Convert.ToInt32(btncodigoProducto.Tag);
                _BE.strCodigoProducto = btncodigoProducto.Text;
                _BE.ocod_vdescripcion = txtdescripcion.Text;
                _BE.strDescProducto = txtdescripcion.Text;
                _BE.ocod_rango_talla = txtgrupo.Text + "/" + txtgrupo2.Text;
                //_BE.ningcd_iid_moneda = 1;
                _BE.ocod_flag_estado = true;
                _BE.ocod_ncantidad = Convert.ToDecimal(txtcantidaddetalle.Text);
                _BE.ocod_ncunitario = Convert.ToDecimal(txtpreciounit.Text);
                _BE.ocod_nmonto_total = Convert.ToDecimal(txttotalitem.Text);
                _BE.ocod_talla1 = Convert.ToInt32((textoTalla[0].Text == "") ? null : textoTalla[0].Text);
                _BE.ocod_talla2 = Convert.ToInt32((textoTalla[1].Text == "") ? null : textoTalla[1].Text);
                _BE.ocod_talla3 = Convert.ToInt32((textoTalla[2].Text == "") ? null : textoTalla[2].Text);
                _BE.ocod_talla4 = Convert.ToInt32((textoTalla[3].Text == "") ? null : textoTalla[3].Text);
                _BE.ocod_talla5 = Convert.ToInt32((textoTalla[4].Text == "") ? null : textoTalla[4].Text);
                _BE.ocod_talla6 = Convert.ToInt32((textoTalla[5].Text == "") ? null : textoTalla[5].Text);
                _BE.ocod_talla7 = Convert.ToInt32((textoTalla[6].Text == "") ? null : textoTalla[6].Text);
                _BE.ocod_talla8 = Convert.ToInt32((textoTalla[7].Text == "") ? null : textoTalla[7].Text);
                _BE.ocod_talla9 = Convert.ToInt32((textoTalla[8].Text == "") ? null : textoTalla[8].Text);
                _BE.ocod_talla10 = Convert.ToInt32((textoTalla[9].Text == "") ? null : textoTalla[9].Text);
                _BE.ocod_cant_talla1 = Convert.ToInt32((textoCantidad[0].Text == "") ? null : textoCantidad[0].Text);
                _BE.ocod_cant_talla2 = Convert.ToInt32((textoCantidad[1].Text == "") ? null : textoCantidad[1].Text);
                _BE.ocod_cant_talla3 = Convert.ToInt32((textoCantidad[2].Text == "") ? null : textoCantidad[2].Text);
                _BE.ocod_cant_talla4 = Convert.ToInt32((textoCantidad[3].Text == "") ? null : textoCantidad[3].Text);
                _BE.ocod_cant_talla5 = Convert.ToInt32((textoCantidad[4].Text == "") ? null : textoCantidad[4].Text);
                _BE.ocod_cant_talla6 = Convert.ToInt32((textoCantidad[5].Text == "") ? null : textoCantidad[5].Text);
                _BE.ocod_cant_talla7 = Convert.ToInt32((textoCantidad[6].Text == "") ? null : textoCantidad[6].Text);
                _BE.ocod_cant_talla8 = Convert.ToInt32((textoCantidad[7].Text == "") ? null : textoCantidad[7].Text);
                _BE.ocod_cant_talla9 = Convert.ToInt32((textoCantidad[8].Text == "") ? null : textoCantidad[8].Text);
                _BE.ocod_cant_talla10 = Convert.ToInt32((textoCantidad[9].Text == "") ? null : textoCantidad[9].Text);

                _BE.ocod_cant_saldo1 = _BE.ocod_cant_talla1 - Convert.ToInt32(_BE.ocod_cant_recibida1); ;
                _BE.ocod_cant_saldo2 = _BE.ocod_cant_talla2 - Convert.ToInt32(_BE.ocod_cant_recibida2); ;
                _BE.ocod_cant_saldo3 = _BE.ocod_cant_talla3 - Convert.ToInt32(_BE.ocod_cant_recibida3); ;
                _BE.ocod_cant_saldo4 = _BE.ocod_cant_talla4 - Convert.ToInt32(_BE.ocod_cant_recibida4); ;
                _BE.ocod_cant_saldo5 = _BE.ocod_cant_talla5 - Convert.ToInt32(_BE.ocod_cant_recibida5); ;
                _BE.ocod_cant_saldo6 = _BE.ocod_cant_talla6 - Convert.ToInt32(_BE.ocod_cant_recibida6); ;
                _BE.ocod_cant_saldo7 = _BE.ocod_cant_talla7 - Convert.ToInt32(_BE.ocod_cant_recibida7); ;
                _BE.ocod_cant_saldo8 = _BE.ocod_cant_talla8 - Convert.ToInt32(_BE.ocod_cant_recibida8); ;
                _BE.ocod_cant_saldo9 = _BE.ocod_cant_talla9 - Convert.ToInt32(_BE.ocod_cant_recibida9); ;
                _BE.ocod_cant_saldo10 = _BE.ocod_cant_talla10 - Convert.ToInt32(_BE.ocod_cant_recibida10); ;
