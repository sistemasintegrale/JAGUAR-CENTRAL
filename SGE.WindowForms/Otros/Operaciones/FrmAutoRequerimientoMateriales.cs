...
{
    public partial class FrmAutoRequerimientoMateriales : DevExpress.XtraEditors.XtraForm
    {
        ...
        public void setValues()
        {
            ...
            lstRequerimientoMaterialesDetalle = new BVentas().listarAutorizacionRequerimientoMaterialesDetalle(oBe.rqmc_icod_requerimiento_materiales);


        }

        public FrmAutoRequerimientoMateriales()
        {
            InitializeComponent();
        }
        ...
        private void modificarItem()
        {
            ...
            using (frmManteAutoRequerimientoMaterielaesDetalle frm = new frmManteAutoRequerimientoMaterielaesDetalle())
            {
                frm.Obe = obe;
                frm.lstRequerimientoMaterialesDetalle = lstRequerimientoMaterialesDetalle;
                frm.SetModify();
