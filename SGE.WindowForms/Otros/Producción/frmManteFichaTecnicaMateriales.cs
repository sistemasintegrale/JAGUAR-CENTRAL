...
{
    public partial class frmManteFichaTecnicaMateriales : DevExpress.XtraEditors.XtraForm
    {
        System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(frmManteFichaTecnicaMateriales));
        ...
        public EFichaTecnicaMateriales _BE = new EFichaTecnicaMateriales();
        ...
        public frmManteFichaTecnicaMateriales()
        {
            InitializeComponent();
        }
        ...
        private void SetSave()
        {
            ...
            try
            {
                ...
                _BE.unidc_icod_unidad_medida = Convert.ToInt32(LkpUnidad.EditValue);
                if (Status == BSMaintenanceStatus.CreateNew)
                {
                    _BE.mo_icod_modelo = icodModelo;
                    _BE.fited_icod_item_ficha_tecnica = new BCentral().insertarFichaTecnicaMateriales(_BE);
                    //Obl.InsertarProdModelo(oBe);
                }
                else
                {
                    new BCentral().modificarFichaTecnicaMateriales(_BE);
                }
        ...
        private void listarProducto()
        {
            try
            {
                ...
                if (frm.ShowDialog() == DialogResult.OK)
                {
                    ...
                    LkpUnidad.EditValue = frm._Be.unidc_icod_unidad_medida;
                    LkpUnidad.Text = frm._Be.StrUnidadMedida;
