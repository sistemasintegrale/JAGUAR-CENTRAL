...
{
    public partial class FrmNotaIngresoRegistroDet : DevExpress.XtraEditors.XtraForm
    {
        public List<EProdProducto> oProducto = new List<EProdProducto>();
        public EProdNotaIngresoDetalle _BE = new EProdNotaIngresoDetalle();
        public int icod_almacen;
        public int icod_motivo;

        public FrmNotaIngresoRegistroDet()
        {
            InitializeComponent();
        }
        ...
        private void AgregarDetalle()
        {
            ...
            try
            {
                ...
                _BE.ningcd_num_item = Convert.ToInt32(txtitem.Text);
                ...
                _BE.ningcd_rango_talla = txtgrupo.Text + "/" + txtgrupo2.Text;
                _BE.ningcd_iid_moneda = 1;
                _BE.pr_ncant_total_producto = Convert.ToDecimal(txtcantidaddetalle.Text);
                _BE.ningcd_monto_unit = Convert.ToDecimal(txtpreciounit.Text);
                _BE.ningcd_monto_total = Convert.ToDecimal(txttotalitem.Text);
                _BE.ningcd_talla1 = Convert.ToInt32((textoTalla[0].Text == "") ? null : textoTalla[0].Text);
                _BE.ningcd_talla2 = Convert.ToInt32((textoTalla[1].Text == "") ? null : textoTalla[1].Text);
                _BE.ningcd_talla3 = Convert.ToInt32((textoTalla[2].Text == "") ? null : textoTalla[2].Text);
                _BE.ningcd_talla4 = Convert.ToInt32((textoTalla[3].Text == "") ? null : textoTalla[3].Text);
                _BE.ningcd_talla5 = Convert.ToInt32((textoTalla[4].Text == "") ? null : textoTalla[4].Text);
                _BE.ningcd_talla6 = Convert.ToInt32((textoTalla[5].Text == "") ? null : textoTalla[5].Text);
                _BE.ningcd_talla7 = Convert.ToInt32((textoTalla[6].Text == "") ? null : textoTalla[6].Text);
                _BE.ningcd_talla8 = Convert.ToInt32((textoTalla[7].Text == "") ? null : textoTalla[7].Text);
                _BE.ningcd_talla9 = Convert.ToInt32((textoTalla[8].Text == "") ? null : textoTalla[8].Text);
                _BE.ningcd_talla10 = Convert.ToInt32((textoTalla[9].Text == "") ? null : textoTalla[9].Text);
                _BE.ningcd_cant_talla1 = Convert.ToInt32((textoCantidad[0].Text == "") ? null : textoCantidad[0].Text);
                _BE.ningcd_cant_talla2 = Convert.ToInt32((textoCantidad[1].Text == "") ? null : textoCantidad[1].Text);
                _BE.ningcd_cant_talla3 = Convert.ToInt32((textoCantidad[2].Text == "") ? null : textoCantidad[2].Text);
                _BE.ningcd_cant_talla4 = Convert.ToInt32((textoCantidad[3].Text == "") ? null : textoCantidad[3].Text);
                _BE.ningcd_cant_talla5 = Convert.ToInt32((textoCantidad[4].Text == "") ? null : textoCantidad[4].Text);
                _BE.ningcd_cant_talla6 = Convert.ToInt32((textoCantidad[5].Text == "") ? null : textoCantidad[5].Text);
                _BE.ningcd_cant_talla7 = Convert.ToInt32((textoCantidad[6].Text == "") ? null : textoCantidad[6].Text);
                _BE.ningcd_cant_talla8 = Convert.ToInt32((textoCantidad[7].Text == "") ? null : textoCantidad[7].Text);
                _BE.ningcd_cant_talla9 = Convert.ToInt32((textoCantidad[8].Text == "") ? null : textoCantidad[8].Text);
                _BE.ningcd_cant_talla10 = Convert.ToInt32((textoCantidad[9].Text == "") ? null : textoCantidad[9].Text);
