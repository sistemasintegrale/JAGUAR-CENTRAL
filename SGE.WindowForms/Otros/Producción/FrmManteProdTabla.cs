...
{
    public partial class FrmManteProdTabla : DevExpress.XtraEditors.XtraForm
    {
        ...
        public EProdTabla Obe = new EProdTabla();
        public List<EProdTabla> lstTabla = new List<EProdTabla>();


        public FrmManteProdTabla()
        {
            InitializeComponent();
        }
        ...
        private void SetSave()
        {
            ...
            try
            {
                ...
                if (Status == BSMaintenanceStatus.CreateNew)
                {
                    Obe.tablc_iid_tipo_tabla = new BCentral().insertarProdTabla(Obe);
                }
                else if (Status == BSMaintenanceStatus.ModifyCurrent)
                {
                    new BCentral().modificarProdTabla(Obe);
                }
            }
            catch (Exception ex)
            {
