...
namespace SGE.WindowForms.Otros.Cuentas_por_Pagar
{
    public partial class FrmManteLetraPorPagar : DevExpress.XtraEditors.XtraForm
    {
        ...
        private void Carga()
        {
            btnRelacionarLetraIMG.Text = "No tiene Imagen";
        ...
        {
            try { pictureEdit1.Image = Image.FromStream(WebDavTest.Get($"{Rutas.RutaImagenes}{Rutas.RutaLetras}{oBe.lexpc_icod_correlativo}/", $"{oBe.lexpc_icod_correlativo}.png")); }
            catch { }
            txtNroLetra.Text = oBe.lexpc_vnumero_letra.Insert(2, " - ");
            ...
            btnRelacionarLetraIMG.Text = pictureEdit1.Image == null ? "No Tiene Imagen" : "Tiene Imagen";
        }
        ...
        private void SetSave()
        {
            ...
            try
            {
                ...
                oBe.lexpc_vnumero_letra = txtNroLetra.Text.Remove(2, 3);
                oBe.lexpc_icorrelativo = 1;
                oBe.lexpc_vnumero_letra_proveedor = txtLetraProv.Text;
                oBe.anioc_iid_anio = Parametros.intEjercicio;
                oBe.mesec_iid_mes = intPeriodo;
        ...
        private void btnRelacionarLetraIMG_Click(object sender, EventArgs e)
        {


            OpenFd.Title = "Insertar Imagen";
            OpenFd.FileName = "";
            OpenFd.Filter = "PNG Imagenes(*.png)|*.png|JPG Imagenes(*.jpg)|*.jpg|JPEG Imagenes(*.jpeg)|*.jpeg"; ;
            if (OpenFd.ShowDialog() == DialogResult.OK)
            {
                ...
                btnRelacionarLetraIMG.Text = "Con Imagen";
            }
        }
        ...
        private void getRuta()
        {
            try
            {
                ...
                ruta = lst[0].pmprc_vruta_letra;
                CountRuta = lst[0].pmprc_vruta_letra.Trim().Length;
            }
            catch (Exception ex)
            {
        ...
        private void btnRelacionarLetraIMG_EditValueChanged(object sender, EventArgs e)
        {
