...
namespace SGI.WindowsForm.Otros.Ventas
{
    ...
    public partial class FrmComunicacionBajaNC : DevExpress.XtraEditors.XtraForm
    {
        ComponentResourceManager resources = new ComponentResourceManager(typeof(FrmComunicacionBajaNC));
        public FrmComunicacionBajaNC()
        {
            KeyUp += new KeyEventHandler(cerrar_form);
            InitializeComponent();
        }

        public ENotaCredito obj = new ENotaCredito();
        ...
        private void SetSave()
        {
            ...
            try
            {
                ...
                {
                    new BVentas().ActualizarMotivoBajaCabeceraNC(obj);
