    ...
    public partial class FrmManteNotaCredito : DevExpress.XtraEditors.XtraForm
    {
        ...
        private void setSave()
        {
            ...
            try
            {
                ...
                oBe.fechaVencimiento = oBe.ncrec_sfecha_credito.ToString("dd/MM/yyyy hh:mm tt");
                ...
                oBe.nombreLegalEmisor = "CALZADOS JAGUAR S.A.C.";
                ...
                oBe.MontoTotalImpuesto = lstDetalle.Sum(x => x.dcrec_nmonto_impuesto);
                oBe.MontoGravadasIGV = oBe.ncrec_nmonto_neto;
                oBe.CodigoTributo = 1000;
                //oBe.TotalIvap = oBe.ncrec_nmonto_ivap;
                //oBe.MontoGravadasIVAP = oBe.ncrec_nmonto_neto_ivap;
                oBe.MontoExonerado = 0;
                oBe.MontoInafecto = 0;
                oBe.MontoGratuitoImpuesto = 0;
                oBe.MontoBaseGratuito = 0;
                oBe.totalIgv = lstDetalle.Sum(x => x.dcrec_nmonto_impuesto);
        ...
        private void setTotales()
        {
            ...
            //else
            //{
            //    txtMontoNeto.Text = "0.0000";                
            //    txtMontoTotal.Text = "0.0000";
            //}
        ...
        public void ListarDet()
        {
            ...
            if (lkpTipoDoc.Text == "FAV")
            {
                ...
                foreach (var item in lstFVDet)
                {
                    ...
                    BENC.ValorVentaItem = Convert.ToDecimal(item.ValorVentaItem);
                    ...
                    BENC.PrecioVentaUnitarioItem = Convert.ToDecimal(item.PrecioVentaUnitarioItem);
