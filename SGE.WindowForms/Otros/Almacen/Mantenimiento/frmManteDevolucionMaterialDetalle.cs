...
{
    public partial class frmManteDevolucionMaterialDetalle : DevExpress.XtraEditors.XtraForm
    {
        ...
        public frmManteDevolucionMaterialDetalle()
        {
            InitializeComponent();
        }
        ...
        private void setValues()
        {
            ...
            txtCantidadEntregada.Text = obe.rqmad_ncantidad_entregada.ToString();
            txtCantDevolvida.Text = obe.rqmad_ncantidad_devuelta.ToString();
            Stock();
        }
        public void Stock()
        {
        ...
        private void setSave()
        {
            ...
            try
            {
                if (Convert.ToDecimal(txtCantidadEntregada.Text) < 0)
                {
                    oBase = txtCantidadEntregada;
                    throw new ArgumentException("La Cantidad Por Entregar debe ser Mayor Igual a Cero");
                }
                if (Convert.ToDecimal(txtCantidadEntregada.Text) >= Convert.ToDecimal(txtCantidadRequerida.Text))
                {
                    oBase = txtCantidadEntregada;
                ...
                obe.rqmad_ncantidad_entregada = Convert.ToDecimal(txtCantidadEntregada.Text);
                obe.rqmad_ncantidad_devuelta = Convert.ToDecimal(txtCantDevolvida.Text);
