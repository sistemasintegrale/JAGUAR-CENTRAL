...
{
    public partial class frmManteEntregaMaterial : XtraForm
    {
        System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(frmManteEntregaMaterial));
        ...
        public ERequerimientoMaterialesDetalle b = new ERequerimientoMaterialesDetalle();
        public List<EEntregaMaterialDet> lstEntergaMaterialDetalle = new List<EEntregaMaterialDet>();
        List<EEntregaMaterialDet> lstDelete = new List<EEntregaMaterialDet>();
        public frmManteEntregaMaterial()
        {
            InitializeComponent();
        }
        ...
        private void SetSave()
        {
            ...
            try
            {
                ...
                if (string.IsNullOrEmpty(Convert.ToString(btncodigoProducto.Text)))
                {
                    oBase = btncodigoProducto;
                    throw new ArgumentException("Selecione Codigo");
                }
                ...
                {
                    new BCentral().ModificarEntregaMaterial(oBe, lstRequerimientoMaterialDetalle, lstEntergaMaterialDetalle, lstDelete);
                }
            }
            catch (Exception ex)
            {
        ...
        private void nuevoToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            using (frmManteEntregaMaterialDetalle frm = new frmManteEntregaMaterialDetalle())
            {
                frm.SetInsert();
                ...
                if (frm.ShowDialog() == DialogResult.OK)
                {
                    ...
                    lstEntergaMaterialDetalle = frm.lstEntergaMaterialDet;
                    grdMateriales.DataSource = lstRequerimientoMaterialDetalle;
                    viewMateriales.RefreshData();
        ...
        {
            return new TextEdit[] { txtcantidad1, txtcantidad2, txtcantidad3, txtcantidad4, txtcantidad5, txtcantidad6, txtcantidad7, txtcantidad8, txtcantidad9, txtcantidad10 };

        }

        private TextEdit[] GetTextoTalla()
        {
            return new TextEdit[] { txttalla1, txttalla2, txttalla3, txttalla4, txttalla5, txttalla6, txttalla7, txttalla8, txttalla9, txttalla10 };
        }
        ...
        private void txtcantidad1_EditValueChanged(object sender, EventArgs e) => Totalizar();
        private void txtcantidad2_EditValueChanged(object sender, EventArgs e) => Totalizar();
        private void txtcantidad3_EditValueChanged(object sender, EventArgs e) => Totalizar();
        private void txtcantidad4_EditValueChanged(object sender, EventArgs e) => Totalizar();
        private void txtcantidad5_EditValueChanged(object sender, EventArgs e) => Totalizar();
        private void txtcantidad6_EditValueChanged(object sender, EventArgs e) => Totalizar();
        private void txtcantidad7_EditValueChanged(object sender, EventArgs e) => Totalizar();
        private void txtcantidad8_EditValueChanged(object sender, EventArgs e) => Totalizar();
        private void txtcantidad9_EditValueChanged(object sender, EventArgs e) => Totalizar();
        private void txtcantidad10_EditValueChanged(object sender, EventArgs e) => Totalizar();
        private void eliminarToolStripMenuItem_Click(object sender, EventArgs e) { }

        private void modificarToolStripMenuItem_Click(object sender, EventArgs e) => Entregar();
        private void Entregar()
        {
            var item = viewMateriales.GetFocusedRow() as ERequerimientoMaterialDet;
            if (item is null) return;
            FrmEntregaMaterial frm = new FrmEntregaMaterial();
            frm.obj.rqmad_icod_item_requerimiento_material = item.rqmad_icod_item_requerimiento_material;
            frm.obj.icod_entrega_material = item.icod_entrega_material;
            frm.Text = $"Entrega del material : {item.strProducto}";
            frm.objItem = item;
            if (frm.ShowDialog() == DialogResult.OK)
            {
                CargarDetalle();
        ...
        private void btnOrdenProduccion_Click(object sender, EventArgs e)
        {
            ...
            using (ListarOrdenProduccion frm = new ListarOrdenProduccion())
            {
                if (frm.ShowDialog() == DialogResult.OK)
                {
                    ...
                    LkpMarca.Text = frm._Be.DesMarca;
