...
{
    public partial class FrmDevolucionMaterial : DevExpress.XtraEditors.XtraForm
    {
        ...
        private void nuevo()
        {
            frmManteDevolucionMaterial frm = new frmManteDevolucionMaterial();
            frm.MiEvento += new frmManteDevolucionMaterial.DelegadoMensaje(reload);
        ...
        private void viewMotonave_DoubleClick(object sender, EventArgs e)
        {
            if (mlist.Count > 0)
            {
                frmManteDevolucionMaterial Motonave = new frmManteDevolucionMaterial();
                Motonave.MiEvento += new frmManteDevolucionMaterial.DelegadoMensaje(reload);
                Motonave.Show();
                Motonave.SetCancel();
                EOrdenProduccion Obe = (EOrdenProduccion)viewMotonave.GetRow(viewMotonave.FocusedRowHandle);
