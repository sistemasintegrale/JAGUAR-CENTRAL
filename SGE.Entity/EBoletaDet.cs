...
namespace SGE.Entity
{
    public class EBoletaDet : EAuditoria
    {
        ...
        public string bovd_vcodigo_extremo_prod { get; set; }
        public string bovd_vdescripcion_prod { get; set; }
        public decimal bovd_ncantidad_total_producto { get; set; }
        public int bovd_icod_serie { get; set; }
        public string bovd_rango_talla { get; set; }
        public int bovd_iid_moneda { get; set; }
        public decimal bovd_monto_unit { get; set; }
        public decimal bovd_monto_total { get; set; }
        public int? bovd_talla1 { get; set; }
        public int? bovd_talla2 { get; set; }
        public int? bovd_talla3 { get; set; }
        public int? bovd_talla4 { get; set; }
        public int? bovd_talla5 { get; set; }
        public int? bovd_talla6 { get; set; }
        public int? bovd_talla7 { get; set; }
        public int? bovd_talla8 { get; set; }
        public int? bovd_talla9 { get; set; }
        public int? bovd_talla10 { get; set; }
        public int? bovd_cant_talla1 { get; set; }
        public int? bovd_cant_talla2 { get; set; }
        public int? bovd_cant_talla3 { get; set; }
        public int? bovd_cant_talla4 { get; set; }
        public int? bovd_cant_talla5 { get; set; }
        public int? bovd_cant_talla6 { get; set; }
        public int? bovd_cant_talla7 { get; set; }
        public int? bovd_cant_talla8 { get; set; }
        public int? bovd_cant_talla9 { get; set; }
        public int? bovd_cant_talla10 { get; set; }
        public long? bovd_iid_kardex1 { get; set; }
        public long? bovd_iid_kardex2 { get; set; }
        public long? bovd_iid_kardex3 { get; set; }
        public long? bovd_iid_kardex4 { get; set; }
        public long? bovd_iid_kardex5 { get; set; }
        public long? bovd_iid_kardex6 { get; set; }
        public long? bovd_iid_kardex7 { get; set; }
        public long? bovd_iid_kardex8 { get; set; }
        public long? bovd_iid_kardex9 { get; set; }
        public long? bovd_iid_kardex10 { get; set; }
        public int bovd_icod_producto1 { get; set; }
        public int bovd_icod_producto2 { get; set; }
        public int bovd_icod_producto3 { get; set; }
        public int bovd_icod_producto4 { get; set; }
        public int bovd_icod_producto5 { get; set; }
        public int bovd_icod_producto6 { get; set; }
        public int bovd_icod_producto7 { get; set; }
        public int bovd_icod_producto8 { get; set; }
        public int bovd_icod_producto9 { get; set; }
        public int bovd_icod_producto10 { get; set; }
        ...
        public decimal bovd_nprecio_neto_item { get; set; }
